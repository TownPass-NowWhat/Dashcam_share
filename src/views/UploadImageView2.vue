...
import ApplyServiceInfoForm from '@/components/molecules/ApplyServiceInfoForm3.vue';
import BaseButton from '@/components/atoms/BaseButton.vue';
import { Dialog, DialogPanel, DialogTitle, TransitionRoot, TransitionChild } from '@headlessui/vue';
import { useFormStore } from '@/stores/form';
import formJSON from '../../public/mock/upload_image_form2.json';
...
<template>
  <div class="pb-8">
    <form @submit.stop="">
      ...
      />
      <!-- 固定按鈕在頁面底部 -->
      <div class="fixed bottom-0 left-0 w-full p-4 font-semibold">
        <BaseButton class="w-full" @click="onSubmitClick">送出通報</BaseButton>
      </div>
    </form>
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            ...
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 shadow-xl transition-all flex flex-col items-center justify-center">
              ...
              <div class="mt-4">
                <BaseButton @click="goToHome">確認</BaseButton> <!-- 點擊確認跳轉回首頁 -->
              </div>
            </DialogPanel>
          </TransitionChild>
        </div>
